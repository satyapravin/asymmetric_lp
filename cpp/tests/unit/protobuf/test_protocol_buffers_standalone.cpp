...
namespace proto {
    ...
    struct Orderbook {
        ...
        const OrderbookLevel& get_bids(int index) const { return bids[index]; }
        const OrderbookLevel& get_asks(int index) const { return asks[index]; }
    ...
    struct PositionSnapshot {
        ...
        const Position& get_positions(int index) const { return positions[index]; }
