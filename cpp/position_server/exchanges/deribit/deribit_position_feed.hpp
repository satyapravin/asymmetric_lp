...
// Deribit-specific position feed implementation
class DeribitPositionFeed : public IExchangePositionFeed {
public:
  DeribitPositionFeed(const std::string& client_id, const std::string& client_secret);
  ~DeribitPositionFeed();
